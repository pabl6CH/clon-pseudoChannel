...
if [ $# -gt 1 ]; then
	...
	SCRIPT_TO_EXECUTE_PLUS_ARGS='git clone https://github.com/FakeTV/pseudo-channel.git . --branch develop'

else
	echo "Downloading the master branch"
	SCRIPT_TO_EXECUTE_PLUS_ARGS='git clone https://github.com/FakeTV/pseudo-channel.git . --branch master'
fi
...
if [ "$FIRST_INSTALL" == "true" ]
	...
	apt-get -y install libxml2-utils recode # NEEDED FOR XML PARSING
	cd ..
